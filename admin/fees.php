...
<?php
$result = $db->prepare("SELECT*  FROM fees WHERE status=1 AND is_nursing=0");
$result->execute();
...
<?php
$result = $db->prepare("SELECT*  FROM fees WHERE status=1 AND is_nursing=1");
$result->execute();
for($i=0; $row = $result->fetch(); $i++){     
$name = $row['fees_name'];
$amount = $row['amount'];
...
<a rel="facebox" href="addtheater.php"> <button class="btn-success" style=""  >add theater charge</button></a></span></br><p></p> 
<?php 
if ($_GET["response"]=1) {
?>
<?php 
...
<?php
$result = $db->prepare("SELECT*  FROM fees WHERE status=1 AND is_nursing=3");
$result->execute();
for($i=0; $row = $result->fetch(); $i++){ 
$id = $row['fees_id'];    
$name = $row['fees_name'];
...
<td><a rel="facebox" href="editcharge.php?id=<?php echo $row['fees_id']; ?>&name=<?php echo $name; ?>&amount=<?php echo $amount; ?>"><button class="btn btn-success" style="height: 5px;" title="click to edit"></button></a> <a rel="facebox" href="delete_charge.php?id=<?php echo $id; ?>"><button class="btn btn-danger" style="height: 5px;" title="click to delete"></button></a> </td><?php }?>
</tr>
<tr> 
</tbody>
</table>

<a rel="facebox" href="addpro.php"> <button class="btn-success" style=""  >add professional charge</button></a></span></br><p></p> 
<?php 
if ($_GET["response"]=1) {
?>
<?php 
...
<?php
$result = $db->prepare("SELECT*  FROM fees WHERE status=1 AND is_nursing=4");
$result->execute();
for($i=0; $row = $result->fetch(); $i++){     
$name = $row['fees_name'];
$amount = $row['amount'];
...
<?php
$result = $db->prepare("SELECT*  FROM fees WHERE status=1 AND is_nursing=2");
$result->execute();
for($i=0; $row = $result->fetch(); $i++){     
$name = $row['fees_name'];
$amount = $row['amount'];
...
$amount = $row['cost'];
$amount = $row['cost']; 
$ins_cost = $row['ins_cost']; 
?>
<tbody>
<tr>
<td><?php echo $name; ?></td> 
<td><?php echo $amount; ?></td>
<td><?php echo $ins_cost; ?></td>
<td><a rel="facebox" href="edittest.php?id=<?php echo $row['id']; ?>&name=<?php echo $name; ?>&amount=<?php echo $amount; ?>&ins_cost=<?php echo $ins_cost; ?>"><button class="btn btn-success" style="height: 5px;" title="click to edit"></button></a> <button class="btn btn-danger" style="height: 5px;" title="Click to Delete"></button> </td><?php }?>
</tr>
<tr> 
</tbody>
</table>
...
<td><a rel="facebox" href="editimage.php?id=<?php echo $row['imaging_id']; ?>&name=<?php echo $name; ?>&amount=<?php echo $amount; ?>"><button class="btn btn-success" style="height: 5px;" title="click to edit"></button></a> <button class="btn btn-danger" style="height: 5px;" title="Click to Delete"></button> </td><?php }?>
</tr>
<tr> 
</tbody>
</table>
...
<td><a rel="facebox" href="editcharge.php?id=<?php echo $row['clinic_id']; ?>&name=<?php echo $name; ?>&amount=<?php echo $amount; ?>"><button class="btn btn-success" style="height: 5px;" title="click to edit"></button></a> <button class="btn btn-danger" style="height: 5px;" title="Click to Delete"></button> </td><?php }?>
</tr>
<tr> 
</tbody>
</table>
