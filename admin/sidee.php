...
<div class="nav-side-menu">
   ...
   <li>&nbsp;&nbsp;<a href="insurance.php?response=0&page=nisurance"> <i class="menu-icon fa fa-line-chart "></i> insurance</a></li>
   <li>&nbsp;&nbsp;<a href="total.php"> <i class="menu-icon fa fa-group "></i> users</a></li>
   <li>&nbsp;&nbsp;<a href="professional.php"> <i class="menu-icon fa fa-group "></i> professionals</a></li>
 </ul>   
    </div>
</div>
