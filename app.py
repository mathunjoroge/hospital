...
app.register_blueprint(hiv_art_bp, url_prefix="/hiv_art")
app.register_blueprint(tb_dots_bp, url_prefix="/tb_dots")
app.register_blueprint(malaria_bp, url_prefix="/malaria")
