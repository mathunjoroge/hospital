...
class TransferOrder(db.Model):
    ...
    items = db.relationship(
        "TransferOrderItem", backref="transfer_order", cascade="all, delete-orphan"
    )
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "source_facility_name": self.source_facility.name
            if self.source_facility
            else None,
            "target_facility_id": self.target_facility_id,
            "target_facility_name": self.target_facility.name
...
class TransferOrderItem(db.Model):
    ...
    transfer_id = db.Column(
        db.Integer, db.ForeignKey("transfer_orders.id"), nullable=False, index=True
    )
