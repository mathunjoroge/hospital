...
NASCOP_REGIMEN_CATALOG = [
    ...
    },
    {
        ...
        "target_pop": "Adult / Adolescent",
        "regimen_name": "TDF + 3TC + ATV/r (Atazanavir/ritonavir)",
        "arv_drug_code": "ARV_TDF_3TC_ATVR",
        "unit_pack_size": "Bottle_30s",
        "keywords": ["atazanavir", "atv/r", "tdf/3tc+atv/r"],
    },
    {
        "regimen_code": "AS1B",
        "regimen_line": "Adult_2nd",
        "target_pop": "Adult / Adolescent",
        "regimen_name": "TDF + 3TC + LPV/r (Lopinavir/ritonavir)",
        "arv_drug_code": "ARV_TDF_3TC_LPVR",
        "unit_pack_size": "Bottle_30s",
        "keywords": ["lopinavir", "lpv/r", "kaletra", "tdf/3tc+lpv/r"],
    },
    {
        "regimen_code": "PF1A",
        "regimen_line": "Ped_1st",
        "target_pop": "Pediatric (<15 yrs)",
        "regimen_name": "pABC/3TC (120/60mg) + DTG (10mg DT)",
    ...
    },
    {
        ...
        "regimen_line": "Ped_1st",
        "target_pop": "Pediatric (<15 yrs)",
        "regimen_name": "ABC/3TC + LPV/r (Pellets / Granules)",
    ...
    },
    {
        ...
        "target_pop": "Pediatric (<15 yrs)",
        "regimen_name": "AZT/3TC + DTG or LPV/r",
        "arv_drug_code": "ARV_AZT_3TC_DTG_PED",
        "unit_pack_size": "Bottle_60s",
        "keywords": ["azt/3tc", "zidovudine/lamivudine", "azt+3tc"],
    },
    {
        "regimen_code": "TL3A",
        "regimen_line": "3rd_Line",
        "target_pop": "All Populations",
        "regimen_name": "Darunavir (DRV) + Ritonavir (r) + Raltegravir (RAL) / DTG",
        "arv_drug_code": "ARV_DRV_R_RAL",
        "unit_pack_size": "Bottle_60s",
        "keywords": ["darunavir", "drv", "raltegravir", "salvage"],
    },
]
