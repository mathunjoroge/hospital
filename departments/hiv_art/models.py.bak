...
class ARTEnrollment(db.Model):
    ...
    adherence_visits = db.relationship('AdherenceVisit', back_populates='art_enrollment', lazy='dynamic')
    viral_loads = db.relationship('ViralLoad', back_populates='art_enrollment', lazy='dynamic')
    cd4_counts = db.relationship('CD4Count', back_populates='art_enrollment', lazy='dynamic')
    who_stages = db.relationship('WHOStage', back_populates='art_enrollment', lazy='dynamic')
...
class AdherenceVisit(db.Model):
    ...
    # Relationship
    art_enrollment = db.relationship('ARTEnrollment', foreign_keys=[art_enrollment_id], back_populates='adherence_visits')
...
class ViralLoad(db.Model):
    ...
    # Relationship
    art_enrollment = db.relationship('ARTEnrollment', foreign_keys=[art_enrollment_id], back_populates='viral_loads')
...
class CD4Count(db.Model):
    ...
    # Relationship
    art_enrollment = db.relationship('ARTEnrollment', foreign_keys=[art_enrollment_id], back_populates='cd4_counts')
...
class WHOStage(db.Model):
    ...
    # Relationship
    art_enrollment = db.relationship('ARTEnrollment', foreign_keys=[art_enrollment_id], back_populates='who_stages')
