...
class Appointment(db.Model):
    ...
    provider_id = db.Column(db.Integer, db.Index=True, nullable=False) # Staff/Clinician ID
    ...
    appointment_type = db.Column(db.String(50), nullable=False) # e.g., CONSULTATION, TELEHEALTH, PROCEDURE
