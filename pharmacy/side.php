...
$result = $db->prepare("SELECT * FROM orders ORDER BY dispense_id DESC LIMIT 1");
  ...
  for($i=0; $row = $result->fetch(); $i++){
      if (isset($row['dispense_id'])) {
    $req=$row['dispense_id']+1;
...
<div class="nav-side-menu">
   ...
   <li>&nbsp;&nbsp;<a href="index.php?search=%20&response=0&token=<?php echo rand(); ?>">Home</a></li>
    <li>&nbsp;&nbsp;<a href='walkin.php?receipt=<?php echo mt_rand(10000000, 99999999); ?>'>walkin patient</a></li>
   <li>&nbsp;&nbsp;<a href='stocks.php'>stocks</a></li>
     <li>&nbsp;&nbsp;<a href='purchases.php?req=<?php echo rand(); ?>'>record purchase</a></li>
   ...
   <li>&nbsp;&nbsp;<a href='#'>drugs ref</a></li>
   <li>&nbsp;&nbsp;<a href='cancer.php'>cancer drugs</a></li>
    <li>&nbsp;&nbsp;<a href='stock_take.php'>stock take</a></li>
 </ul>   
    </div>
</div>
