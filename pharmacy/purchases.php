...
<span><select id="medicine" name="med" class="selectpicker" select class="selectpicker" data-live-search="true" title="Please select a medicine..." >
<?php 
include ('../connect.php');
...
<input name="qty" style="height: 2.5em;width:8em;" type="number" min="1" placeholder="qty">
<input name="batch" style="height: 2.5em;width:8em;" type="text" min="1" placeholder="batch number">
<input name="cost" style="height: 2.5em;width:8em;" type="number" min="1" placeholder="total cost">&nbsp;<button class="btn btn-success btn-large">add</button></form></span></div>
