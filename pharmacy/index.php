...
setTimeout(function() {
    $('#preturns').fadeOut('fast');
}, 3000);
    </script>
    <div id="alert">
        <p class="text text-success">drugs dispensed</p>
    </div>
    <?php } ?>
...
<td colspan="1" id="myvalue"><strong style="font-size: 12px; color: #222222;"> <?php echo round($row['total']); ?> </td><?php } ?>
</tbody>
</table>
</br>
...
?>
<p></p>
<div class="alert alert-success" class="preturns" style="width: 35%;">drugs returned and stock adjusted appropriately</div><?php } ?></div></div>
<script>
