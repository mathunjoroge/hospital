...
<?php 
include ('../connect.php');
$result = $db->prepare("SELECT * FROM patients WHERE `opno` LIKE '%/%' ORDER BY id DESC LIMIT 1");
$result->execute();
$result->execute();
...
<select name="sex" class="form-control" required><option  disabled>select sex</option>
<option >male</option>
...
<select id="fee" class="selectpicker form-control"  title="select fees" data-live-search='true'  name="fees[]"  multiple required />
<option  disabled>-- Select payable fees--</option><?php 
include ('../connect.php');
...
<label for="inputtext4">mode of payment</label>
<select name="payment_mode" class="form-control" required><option disabled>select payment mode</option>
<option value="0">cash</option>
<option value="1">insuranace</option>
</select>
</div>
</div>
